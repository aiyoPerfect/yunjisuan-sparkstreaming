...
//    val folderPath ="C:\\Users\\hwj\\Documents\\金庸数据\\三部曲（含昵称）\\"
    val folderPath ="E:\\code\\cloudComputing\\jinyong\\jinyong\\resources\\Person\\"
//    val folderPath = "hdfs://hadoop000:8020/data/jy/hero"
    val graph1 = creatGraph(sc,folderPath+"result1\\tag.txt",
      folderPath+"result1\\relations.txt",15).cache()

    val graph2 = creatGraph(sc,folderPath+"result2\\tag.txt",
      folderPath+"result2\\relations.txt",15).cache()

    val graph3 = creatGraph(sc,folderPath+"result3\\tag.txt",
      folderPath+"result3\\relations.txt",15).cache()
...
//    val folderPath2 ="C:\\Users\\hwj\\Documents\\金庸数据\\人物与武功秘籍\\"
    val folderPath2 ="E:\\code\\cloudComputing\\jinyong\\jinyong\\resources\\人物与武功秘籍\\"
